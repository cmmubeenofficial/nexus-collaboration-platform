...
import { documentsTourSteps } from '../../config/tourSteps';
...
export const DocumentsPage: React.FC = () => {
  ...
  // Auto-start documents tour on first visit
  useEffect(() => {
    if (!hasCompletedTour('documents') && currentTour !== 'documents') {
  ...
  return (
    <>
      ...
      <div data-tour="documents-container" className="space-y-6 animate-fade-in relative pb-10">
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-start">
          ...
          <div className="flex-1 flex flex-col min-w-0 gap-6 w-full">
            ...
            {/* Table */}
            <div data-tour="documents-list" className="bg-white rounded-xl border border-gray-200 overflow-hidden shadow-sm">
                  ...
                  <tbody className="divide-y divide-gray-100">
                    {filteredDocs.map((doc) => (
                      <tr
                        ...
                        className={`cursor-pointer transition-colors group ${selectedDoc.id === doc.id
            ...
            <div
              ...
              onDrop={handleDrop}
              onClick={handleUploadClick}
              className={`border-2 border-dashed rounded-xl p-10 flex flex-col items-center justify-center cursor-pointer transition-all ${isDragging
                ? 'border-primary-400 bg-primary-50 scale-[1.01]'
                : 'border-gray-200 bg-white hover:border-gray-300 hover:bg-gray-50'
                }`}
            >
              <div className={`w-14 h-14 rounded-full flex items-center justify-center border mb-3 transition-transform ${isDragging ? 'bg-primary-100 border-primary-300 text-primary-600 scale-110' : 'bg-gray-50 border-gray-200 text-gray-400'
                }`}>
                <FilePlus size={24} />
              </div>
          ...
          <div data-tour="documents-preview" className="hidden lg:flex flex-col w-[400px] xl:w-[440px] shrink-0 sticky top-6 self-start h-[calc(100vh-140px)] min-h-[600px] bg-white rounded-xl border border-gray-200 overflow-hidden shadow-sm">
            {selectedDoc ? (
              <DocumentPreviewPane
                key={selectedDoc.id}
