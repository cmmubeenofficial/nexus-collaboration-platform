...
export const InvestorDashboard: React.FC = () => {
  ...
  useEffect(() => {
    if (user && !hasCompletedTour('dashboard') && currentTour !== 'dashboard') {
      const timer = setTimeout(() => {
        startTour('dashboard');
      }, 1000);
      return () => clearTimeout(timer);
    }
  }, [user, hasCompletedTour, startTour, currentTour]);
  ...
  return (
    <>
      ...
      <div data-tour="dashboard-container" className="space-y-6 animate-fade-in">
        ...
        <div className="flex flex-col md:flex-row gap-4">
          <div data-tour="dashboard-search" className="w-full md:w-2/3">
            <Input
          ...
          <div data-tour="dashboard-filters" className="w-full md:w-1/3">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-6">
            <Card data-tour="dashboard-meetings">
            ...
            {/* Video Call Widget */}
            <Link
              data-tour="dashboard-video-call"
              to="/video-call"
            ...
            {/* Audio Call Widget */}
            <Link
              data-tour="dashboard-audio-call"
              to="/audio-call"
